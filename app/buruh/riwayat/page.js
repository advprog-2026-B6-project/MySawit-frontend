...
export default function BuruhRiwayatPage() {
  ...
  useEffect(() => {
    fetchHistory();
    // TODO: Integrasikan role guard dari auth context agar hanya role BURUH dapat mengakses halaman ini.
  }, []);
  ...
  return (
    <main style={{ maxWidth: "900px", margin: "0 auto", padding: "24px" }}>
      <h1>Riwayat Panen Pribadi Buruh</h1>
      ...
      {!loading && reports.length === 0 ? (
        <p style={{ marginTop: "16px" }}>Belum ada riwayat panen untuk filter saat ini.</p>
      ) : null}
